...
write.table(result1, "pan_mammalian_clock1_hg19_Altai_Neandertal.csv",
  row.names = FALSE, sep = ",")
...
write.table(result2, "pan_mammalian_clock2_hg19_Altai_Neandertal.csv",
  row.names = FALSE, sep = ",")
...
write.table(result3, "pan_mammalian_clock3_hg19_Altai_Neandertal.csv",
  row.names = FALSE, sep = ",")