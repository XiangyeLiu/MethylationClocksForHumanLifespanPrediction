#file requirements
#cluster and outlier information of target methylation sites in two .RData files
...
dataold <- read.table("age_old_enhanced.csv", header = TRUE, sep = ",")
dataold <- dataold[-nrow(dataold), ]

load("detailed_methylation_level_enhanced.RData")
load("boundary_methylation_level_enhanced.RData")
